        ...
        <div class="Questions" id="Questions">
            ...
            <div class="Question">
                <div class="Header">
                    ...
                    <input value="<%=Q.getContent() %>" id="question" name="question" type="text"/>
                    <input value="<%=Q.getId_question() %>" id="id_question" name="id_question" type="number" placeholder="id_question"/>
                    <input value="<%=Q.getDuration() %>" id="duration" name="duration" type="number" placeholder="question duration"/>
                    <input value="<%=Q.getScore() %>" id="score" name="score" type="number" placeholder="question score"/>
                </div>
                <div class="Body">
                    <div class="Answer">
